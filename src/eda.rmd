...
```{r}
# Fit Holt-Winter's model with (M)ultiplicative error, (A)dditive trend, and (M)ultiplicative seasonality
...
# AAN: Additive error (A), (A)dditive trend, and (N)o seasonality
...
```{r}
# Fit ARIMA model
sales_arima <- Arima(sales_train_ts, order = c(1, 0, 0), seasonal = c(0, 0, 2))

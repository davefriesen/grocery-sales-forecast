...
<br><br>
* __[Time Series Components? (28)]__ - Store sales at daily and weekly frequencies, across and within individual product families, exhibit systematic components of [average] level (by default), trend (changes from one period to the next), and [multiplicative?] seasonality, or cyclical behavior. Of course, all include non-systematic "noise."
...
```{r}
#
Acf(sales_ts, lag.max = 12, type = "correlation", plot = TRUE,
    main = "Store Sales for Select Product Families  |  Autocorrelation",
